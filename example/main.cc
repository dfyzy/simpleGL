...
int main() {
	...
	Image bodyFront(GL_LINEAR);	bodyFront.loadData("example/body_front.png");
	Image brim(GL_LINEAR);			brim.loadData("example/brim.png");
	Image light(GL_LINEAR);			light.loadData("example/light.png");
	Image eye(GL_LINEAR);			eye.loadData("example/eye.png");
